...
public record Entry
{
    public List<string> SignalPattern { get; init; } = null!;
    public List<string> OutputValue { get; init; } = null!;
}

public record SignalWireSegmentCombinations
{
    public char SignalWire { get; init; }
    public List<char> PossibleSegments {get; init; } = null!;
}

public record SignalNumberCombinations
{
    public string Signal { get; init; } = null!;
    public List<int> PossibleNumbers { get; init; } = null!;
}